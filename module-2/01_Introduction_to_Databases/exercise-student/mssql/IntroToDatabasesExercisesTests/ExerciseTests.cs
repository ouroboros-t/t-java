...
namespace IntroToDatabasesExercisesTests
{
    [TestClass]
    public class ExerciseTests
    {
        private static readonly string connectionString = @"Data Source=.\SQLEXPRESS;Initial Catalog=UnitedStates;Integrated Security=SSPI;";
