...
namespace InsertUpdateDeleteTests
{
    [TestClass]
    public class ExerciseTests
    {
        private static readonly string mainConnectionString = @"Data Source=.\SQLEXPRESS;Initial Catalog=master;Integrated Security=SSPI;";
        private static readonly string movieConnectionString = @"Data Source=.\SQLEXPRESS;Initial Catalog=MovieDBTemp;Integrated Security=SSPI;";
        ...
        public void ExerciseProblem10()
        {
            ...
            dtExpected.Rows.Add(new object[] { "Anthony Daniels (born 21 February 1946) is an English actor. He is best known for his role as the droid C-3PO in the Star Wars series of films made between 1977 and 2005.\r\n\r\nDescription above from the Wikipedia article Anthony Daniels, licensed under CC-BY-SA, full list of contributors on Wikipedia.​ http://www.anthonydaniels.com/" });
