...
public class JdbcTimesheetDaoTests extends BaseDaoTests {
    ...
    @Test
    public void getBillableHours_returns_correct_total_for_employee1() {
        // Arrange - Already taken care of

        // Act
        double actual = sut.getBillableHours(1L, 1L);

        // Assert
        Assert.assertEquals(2.5, actual, 0.1);
    }

    @Test
    public void getBillableHours_returns_correct_total_for_employee2() {
        // Arrange - Already taken care of
        ...
        // Assert
        Assert.assertEquals(0.0, actual, 0.1);
    }
