...
public class Lecture {
    ...
    */
    public String returnFizzIfThree(int number) {
        ...
        return ""; <-- you HAVE TO put a return String
         */
    /*
    ...
    */
    public String returnFizzIfThreeUsingTernary(int number) {
        ...
        return returnValue; //still need return statement for ternary operator!
        //return "";
    }
    ...
    */
    public String returnAdultOrMinor(int number) {
        if (number >= 18) { //can also write (number == 18 || number > 18)
            return "Adult";
        } else {
            return "Minor";
        }
