...
public class Examples {
	...
	public static void main(String[] args) {
		...
		// final variables must be given a value when declared and cannot change. final variables have all uppercase names and underscores
		final int DAYS_PER_WEEK = 7;
		//DAYS_PER_WEEK = 8; // Causes a compiler error because the variable is final
