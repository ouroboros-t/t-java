...
public class Lecture {
    ...
    public void declaringArrays() {
        ...
        int[] scores2 = new int[]{95, 100, 90};

        int[] scores3 = {95, 100, 90};

        int aScore = scores3[10]; // Throws an exception
    ...
    */
    ...
    /*
    4. Return the first element of the array from the parameter
    */
    ...
    /*
    5. Return the last element of the array from the parameter
    */
    public int returnLastElementOfParam(int[] passedInArr) {
        return passedInArr[passedInArr.length - 1];
    }
    ...
    */
    ...
    11.5 Return sum
     */
    public double sumOfDoubles(double[] arrayToSum) {  // Example: { 1.0, 2.0, 3.0 }
        double sum = 0.0;
