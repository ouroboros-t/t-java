...
* If the application window closes immediately after it displays the results, you can add a `Console.Read()` statement before the end of the method. This keeps the window open until you press another key, which allows you to review what's displayed before the application ends.
